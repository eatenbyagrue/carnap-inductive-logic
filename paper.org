...
Both requirements, symmetry and \Str{}-symmetry, taken together yield a unique confirmation function \c* which Carnap describes in the appendix of this Foundations \LFp{563f.}. Carnap first, again, defines \m*:
\[
...
#+NAME: fig:tableaux
| \Str_i | \Z_j | P(a) | P(b) | P(c) | P(d) | \m\dag(\Str_i) | \m\dag(\Z_j)  | \m*(\Str_i)  | \m*(\Z_j)     |
|--------+------+------+------+------+------+----------------+---------------+--------------+---------------|
|--------+------+------+------+------+------+----------------+---------------+--------------+---------------|
...
- But with Str-symmetry we get PIR (show derivation, neat. Maybe at the end of the circus.
  ...
  - Also describe mKreuz und cKreuz (siehe Anhang cite:carnap50_logic_found_probab und ?)     
...
cite:carnap55_statis_induc_probab
